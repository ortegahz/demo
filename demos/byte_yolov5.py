...
if __name__ == '__main__':
    ...
    with Manager() as manager:
        ...
        while True:
            ...
            # if len(online_targets) > 0:
            #     for i in range(len(arr_frames) - 1):  # ignore last frame
            #         if arr_frames[i][0] == idx_frame:
            #             print(f'found match idx_frame -> {idx_frame}')
            #             # arr_frames[i][2] = online_targets
            #             item_frame[2] = online_targets
            #             arr_frames.pop(i)
            #             arr_frames.insert(i, item_frame)
            #             break
