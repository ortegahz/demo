...
config.USE_DECONVOLUTION = False
...
# network.mnet.pretrained = 'model/mobilenet_0_25_retina'
network.mnet.pretrained = 'model/mobilenet_0_25'
# network.mnet.pretrained = 'model/mobilenet1.0'
# network.mnet.pretrained = 'model/resnet18_v1'
# network.mnet.pretrained = 'model/resnet10_v1'
network.mnet.pretrained_epoch = 0
network.mnet.max_feat_channel = 8888
network.mnet.COLOR_MODE = 1
network.mnet.USE_CROP = True  # run test_widerface.py fail without crop layers
network.mnet.USE_DECONVOLUTION = True
...
# network.mnet.lr_step = '1,2,3,4,5,55,68,80'


network.resnet = edict()
network.resnet.pretrained = 'model/resnet10_v1'
# network.resnet.pretrained = 'model/resnet18_v1'
...
network.resnet.LAYER_FIX = False
network.resnet.USE_CROP = True  # run test_widerface.py fail without crop layers
network.resnet.USE_DECONVOLUTION = True
network.resnet.RPN_BATCH_SIZE = 256
network.resnet.RPN_ANCHOR_CFG = RAC_RETINA
network.resnet.LANDMARK_LR_MULT = 2.5
...
dataset.retinaface.root_path = '/media/manu/samsung/widerface/data'
dataset.retinaface.dataset_path = '/media/manu/samsung/widerface/data/retinaface'
